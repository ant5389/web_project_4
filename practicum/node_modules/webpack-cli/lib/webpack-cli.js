...
const { program } = require('webpack-cli/lib/node_modules/commander');
const utils = require('webpack-cli/lib/utils');

class WebpackCLI {
    constructor() {
        // Global
        this.webpack = require('webpack-cli/lib/node_modules/webpack');
    ...
    async run(args, parseOptions) {
        ...
        const outputVersion = async (options) => {
            ...
            const pkgJSON = require('webpack-cli/package.json');
            ...
            if (this.utils.packageExists('webpack-dev-server')) {
                ...
                const { version } = require('webpack-cli/lib/node_modules/webpack-dev-server/package.json');
    ...
    async resolveConfig(options) {
        ...
        if (options.merge) {
            const { merge } = require('webpack-cli/lib/node_modules/webpack-merge');
    ...
    async applyCLIPlugin(config, cliOptions) {
        const addCLIPlugin = (configOptions) => {
            ...
            const CLIPlugin = require('webpack-cli/lib/plugins/CLIPlugin');
    ...
    async buildCommand(options, isWatchCommand) {
        ...
        const callback = (error, stats) => {
            ...
            if (options.json) {
                const { stringifyStream: createJsonStringifyStream } = require('webpack-cli/lib/node_modules/@discoveryjs/json-ext');
